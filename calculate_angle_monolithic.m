function [res] = calculate_angle_monolithic(joint_angles_sym, transformation_matrix_ee_sym, previous_joint_angle_vector, waypoint)
...
while dist_to_waypoint_scalar > 1e-12
    ...
    if jacobian_condition_num > 1e6
        error('Warning: Jacobian is ill-conditioned!');
    end
